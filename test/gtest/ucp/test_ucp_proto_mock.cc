...
public:
                         ...
                         ucp_operation_id_t op_id)
    {
        ...
        check_rkey_config(
                ...
                {
                        {0, INF, "zero-copy",
                         "64% on rc_mlx5/mock_1:1 and 36% on rc_mlx5/mock_0:1"},
                },
        ...
        check_rkey_config(
                ...
                {
                        {0, INF, "zero-copy",
                         "50% on rc_mlx5/mock_1:1 and 50% on rc_mlx5/mock_0:1"},
                },
...
{
    test_port_speed(
            [this]() { return send_recv_rma(64 * UCS_KBYTE, UCP_OP_ID_PUT); },
            UCP_OP_ID_PUT);
}
...
{
    test_port_speed(
            [this]() { return send_recv_rma(64 * UCS_KBYTE, UCP_OP_ID_GET); },
            UCP_OP_ID_GET);
}
